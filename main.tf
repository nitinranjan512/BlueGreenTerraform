locals {
  ...
  private_a_subnet_id = "subnet-059157432971fbeda"
  private_b_subnet_id = "subnet-04104dca202b0a044"
  public_a_subnet_id  = "subnet-02153b4c275902d4a"
  public_b_subnet_id  = "subnet-0537d4c69395a2291"
